    ...
    <div className="space-y-6">
      ...
      <div className="bg-slate-900/90 border border-slate-800 rounded-2xl p-4 sm:p-6 shadow-xl">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <span className="text-xs px-3 py-1.5 rounded-full bg-indigo-500/20 text-indigo-300 border border-indigo-500/30 font-medium">
              1:1 Carry Forward Guaranteed
            </span>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        ...
        <div className="p-5 rounded-2xl bg-slate-900/90 border border-slate-800 hover:border-indigo-500/50 transition-all flex flex-col justify-between shadow-lg group">
          <div>
            <div className="flex items-center justify-between mb-3">
              <div className="w-10 h-10 rounded-xl bg-indigo-500/20 text-indigo-400 flex items-center justify-center border border-indigo-500/30">
                <Users className="w-5 h-5" />
              </div>
              <span className="text-xs font-bold px-2.5 py-1 rounded-full bg-indigo-500/20 text-indigo-300 font-mono">
            ...
            <div className="p-3 bg-slate-950/80 rounded-xl text-xs space-y-1.5 border border-slate-800/80">
              <div className="flex justify-between text-slate-300">
                <span>{isHinglish ? 'Starter Package (₹1k):' : 'Starter Package:'}</span>
                <span className="font-mono text-emerald-400 font-semibold">{formatCurrency(100)}</span>
              </div>
              <div className="flex justify-between text-slate-300">
                <span>{isHinglish ? 'Silver Package (₹5k):' : 'Silver Package:'}</span>
                <span className="font-mono text-emerald-400 font-semibold">{formatCurrency(500)}</span>
              </div>
              <div className="flex justify-between text-slate-300">
                <span>{isHinglish ? 'Diamond Package (₹25k):' : 'Diamond Package:'}</span>
                <span className="font-mono text-emerald-400 font-semibold">{formatCurrency(2500)}</span>
              </div>
            </div>
          </div>
          ...
          <div className="mt-4 pt-3 border-t border-slate-800 flex items-center justify-between text-[11px] text-slate-500">
            ...
            <span className="text-emerald-400 font-medium">{isHinglish ? 'Unlimited Directs' : 'No Limit'}</span>
          </div>
        </div>

        {/* 2. BINARY MATCHING PAIR INCOME */}
        <div className="p-5 rounded-2xl bg-slate-900/90 border border-slate-800 hover:border-blue-500/50 transition-all flex flex-col justify-between shadow-lg group">
          <div>
            <div className="flex items-center justify-between mb-3">
              <div className="w-10 h-10 rounded-xl bg-blue-500/20 text-blue-400 flex items-center justify-center border border-blue-500/30">
                <ArrowLeftRight className="w-5 h-5" />
              </div>
              <span className="text-xs font-bold px-2.5 py-1 rounded-full bg-blue-500/20 text-blue-300 font-mono">
                {settings.binaryMatchingPercent}% (1:1 Ratio)
              </span>
            </div>
            <h3 className="text-base font-bold text-white mb-1 group-hover:text-blue-300 transition">
            ...
            <div className="p-3 bg-slate-950/80 rounded-xl text-xs space-y-1.5 border border-slate-800/80">
              <div className="flex justify-between text-slate-300">
                ...
                <span className="font-mono text-white font-semibold">1:1 (L:R)</span>
              </div>
              <div className="flex justify-between text-slate-300">
                <span>{isHinglish ? 'Carry Forward:' : 'Carry Forward:'}</span>
                <span className="text-emerald-400 font-semibold">{isHinglish ? 'Haan (Lifetime)' : 'Yes (Lifetime)'}</span>
              </div>
              <div className="flex justify-between text-slate-300">
                <span>{isHinglish ? 'Daily Capping:' : 'Daily Capping:'}</span>
                <span className="font-mono text-amber-400 font-semibold">Up to {formatCurrency(60000)}/Day</span>
              </div>
            </div>
          </div>
          ...
          <div className="mt-4 pt-3 border-t border-slate-800 flex items-center justify-between text-[11px] text-slate-500">
            ...
            <span className="text-blue-400 font-medium">{isHinglish ? 'Core MLM Engine' : 'Core Stream'}</span>
          </div>
        </div>

        {/* 3. GENERATION LEVEL COMMISSION */}
        <div className="p-5 rounded-2xl bg-slate-900/90 border border-slate-800 hover:border-purple-500/50 transition-all flex flex-col justify-between shadow-lg group">
          <div>
            <div className="flex items-center justify-between mb-3">
              <div className="w-10 h-10 rounded-xl bg-purple-500/20 text-purple-400 flex items-center justify-center border border-purple-500/30">
                <Layers className="w-5 h-5" />
              </div>
              <span className="text-xs font-bold px-2.5 py-1 rounded-full bg-purple-500/20 text-purple-300 font-mono">
                Level 1 to 7
              </span>
            </div>
            ...
            <div className="p-3 bg-slate-950/80 rounded-xl text-xs space-y-1 border border-slate-800/80 max-h-28 overflow-y-auto">
              {settings.levels.map((lvl) => (
                <div key={lvl.level} className="flex justify-between text-slate-300 text-[11px]">
                  <span>Level {lvl.level}:</span>
                  <span className="font-mono text-purple-300 font-semibold">{lvl.percent}%</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="mt-4 pt-3 border-t border-slate-800 flex items-center justify-between text-[11px] text-slate-500">
            ...
            <span className="text-purple-400 font-medium">{isHinglish ? 'Team Multiplier' : 'Team Override'}</span>
          </div>
        </div>

        {/* 4. DAILY CASHBACK / ROI */}
        <div className="p-5 rounded-2xl bg-slate-900/90 border border-slate-800 hover:border-teal-500/50 transition-all flex flex-col justify-between shadow-lg group">
          <div>
            <div className="flex items-center justify-between mb-3">
              <div className="w-10 h-10 rounded-xl bg-teal-500/20 text-teal-400 flex items-center justify-center border border-teal-500/30">
                <Clock className="w-5 h-5" />
              </div>
              <span className="text-xs font-bold px-2.5 py-1 rounded-full bg-teal-500/20 text-teal-300 font-mono">
                0.5% - 1% Daily
              </span>
            </div>
            <h3 className="text-base font-bold text-white mb-1 group-hover:text-teal-300 transition">
            ...
            <div className="p-3 bg-slate-950/80 rounded-xl text-xs space-y-1.5 border border-slate-800/80">
              <div className="flex justify-between text-slate-300">
                ...
                <span className="font-mono text-teal-400 font-semibold">₹5 / Day (₹1,000 total)</span>
              </div>
              <div className="flex justify-between text-slate-300">
                <span>Gold (₹10,000):</span>
                <span className="font-mono text-teal-400 font-semibold">₹75 / Day (₹15,000 total)</span>
              </div>
              <div className="flex justify-between text-slate-300">
                <span>Diamond VIP (₹25,000):</span>
                <span className="font-mono text-teal-400 font-semibold">₹250 / Day (₹50,000 total)</span>
              </div>
            </div>
          </div>
          ...
          <div className="mt-4 pt-3 border-t border-slate-800 flex items-center justify-between text-[11px] text-slate-500">
            ...
            <span className="text-teal-400 font-medium">{isHinglish ? 'Non-Working' : 'Passive'}</span>
          </div>
        </div>

        {/* 5. RANK & REWARDS */}
        <div className="p-5 rounded-2xl bg-slate-900/90 border border-slate-800 hover:border-amber-500/50 transition-all flex flex-col justify-between shadow-lg group">
          <div>
            <div className="flex items-center justify-between mb-3">
              <div className="w-10 h-10 rounded-xl bg-amber-500/20 text-amber-400 flex items-center justify-center border border-amber-500/30">
                <Trophy className="w-5 h-5" />
              </div>
              <span className="text-xs font-bold px-2.5 py-1 rounded-full bg-amber-500/20 text-amber-300 font-mono">
                Physical / Cash
              </span>
            </div>
            ...
            <div className="p-3 bg-slate-950/80 rounded-xl text-xs space-y-1.5 border border-slate-800/80 max-h-32 overflow-y-auto">
              {settings.ranks.map((r) => (
                <div key={r.rank} className="flex justify-between items-center text-slate-300 text-[11px]">
          ...
          <div className="mt-4 pt-3 border-t border-slate-800 flex items-center justify-between text-[11px] text-slate-500">
            ...
            <span className="text-amber-400 font-medium">{isHinglish ? 'Rewards Club' : 'Rewards Club'}</span>
          </div>
        </div>

        {/* 6. ROYALTY LEADERSHIP POOL */}
        <div className="p-5 rounded-2xl bg-slate-900/90 border border-slate-800 hover:border-rose-500/50 transition-all flex flex-col justify-between shadow-lg group">
          <div>
            <div className="flex items-center justify-between mb-3">
              <div className="w-10 h-10 rounded-xl bg-rose-500/20 text-rose-400 flex items-center justify-center border border-rose-500/30">
                <Crown className="w-5 h-5" />
              </div>
              <span className="text-xs font-bold px-2.5 py-1 rounded-full bg-rose-500/20 text-rose-300 font-mono">
            ...
            <div className="p-3 bg-slate-950/80 rounded-xl text-xs space-y-1.5 border border-slate-800/80">
              ...
              <div className="flex justify-between text-slate-300">
                ...
                <span className="text-emerald-400 font-semibold">Diamond VIP</span>
              </div>
            </div>
          </div>
          ...
          <div className="mt-4 pt-3 border-t border-slate-800 flex items-center justify-between text-[11px] text-slate-500">
            ...
            <span className="text-rose-400 font-medium">{isHinglish ? 'Top Leaders' : 'Leadership'}</span>
          </div>
        </div>

        {/* 7. SPILLOVER BENEFIT (AUTO-SPILL) */}
        <div className="p-5 rounded-2xl bg-slate-900/90 border border-slate-800 hover:border-emerald-500/50 transition-all flex flex-col justify-between shadow-lg group md:col-span-2 lg:col-span-3">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            ...
            <div className="p-3 bg-slate-950 rounded-xl border border-emerald-900/40 text-xs min-w-max">
              <span className="text-slate-400 block text-[11px]">{isHinglish ? 'Auto Placement Mode' : 'Spill Rule'}</span>
              <span className="font-mono text-emerald-300 font-bold">Extreme Left / Weaker Leg</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="p-4 rounded-xl bg-slate-950/70 border border-slate-800/80 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 text-xs text-slate-400">
        <div className="flex items-center gap-2">
